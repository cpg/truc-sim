...
#
# This module the main code to drive the playing and also the simulation of Truc games.
#
...
def benchmark_truc(level, concise_output = false)
	start = Time.now
	r = []
	1.upto(10000) do
	      g = Game.new
...
def do_all_benchmarks(concise_output = false)
	...
	8.upto(22) do |level|
		benchmark_truc(level, concise_output)
	end
end
